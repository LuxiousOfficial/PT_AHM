  ...
  <body>
    ...
    <section class="home-dealer">
      <div class="container-fluid">
        <h2 class="text-center text-capitalize fw-bold fs-1">promo</h2>
        <div class="row">
          <div class="owl-carousel owl-theme mt-5">
            <div class="item">
              <div class="card mb-2 shadow">
                <img src="img/dealer1.webp" alt="image" class="card-img-top">
                <div class="card-body">
            ...
            <div class="item">
              <div class="card mb-2 shadow">
                <img src="img/dealer2.webp" alt="image" class="card-img-top">
                <div class="card-body">
                  <h4>dealer honda bigWing</h4>
                  <p>Dealer penjualan sepeda motor Honda dengan premium service yang melayani: Penjualan Honda Big Bike Honda premium model (Matic, Sport dan Cub)</p>
                  <a href="#">selengkapnya</a>
            ...
            <div class="item">
              <div class="card mb-2 shadow">
                <img src="img/dealer3.webp" alt="image" class="card-img-top">
                <div class="card-body">
                  <h4>dealer honda bigWing</h4>
                  <p>Dealer penjualan sepeda motor Honda dengan premium service yang melayani: Penjualan Honda Big Bike Honda premium model (Matic, Sport dan Cub)</p>
                  <a href="#">selengkapnya</a>
